...
Copyright (c) 2020-2026 Linux-HA Japan Project
...
## 動作条件・バージョン
* 現時点のPacemaker追加パッケージの最新バージョンは、pm_extra_tools-1.8-1 です。
* 動作を確認しているOS・バージョンは、RHEL 8.10 HA Add-On / RHEL 9.7 HA Add-On / RHEL 10.1 HA Add-On です。
...
* [Linux-HA Japan プロジェクト](https://linux-ha-japan.github.io/wp/) > [OSC2020 Tokyo/Spring セミナー資料](https://linux-ha-japan.github.io/wp/archives/4942)
* [Linux-HA Japan プロジェクト](https://linux-ha-japan.github.io/wp/) > [OSC2020 Tokyo/Fall セミナー資料](https://linux-ha-japan.github.io/wp/archives/4970)
